# -*- coding: utf-8 -*-
#
# pkgwat documentation build configuration file, created by
# sphinx-quickstart on Wed Aug 15 15:20:57 2012.
#
...
project = u'pkgwat'
copyright = u'2012, Red Hat, Inc.  Ralph Bean <rbean@redhat.com>'
...
latex_documents = [
  ('index', 'pkgwat.tex', u'pkgwat Documentation',
   u'Red Hat, Inc.  Ralph Bean \\textless{}rbean@redhat.com\\textgreater{}', 'manual'),
]
...
texinfo_documents = [
  ('index', 'pkgwat', u'pkgwat Documentation',
   u'Red Hat, Inc.  Ralph Bean <rbean@redhat.com>', 'pkgwat', 'One line description of project.',
   'Miscellaneous'),
]
